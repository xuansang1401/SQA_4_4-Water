                ...
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <a href="#addEmployeeModal1" class="btn btn-success" id="btn_add_gia_nuoc" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New </span></a>
                        ...
                        <tbody>
                            <c:forEach items="${listCN}" var="o" >
                                <tr>
                                    ...
                                    <td>
                                        <a onclick="openEdit1('${o.getId()}','${o.getLuongNuoc()}','${o.getDonGia()}','${o.getNamApdung()}')"  class="edit" data-toggle="modal"><i id="btn_edit_nuoc${o.getId()}" class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                        <a onclick="openDelete1(${o.getId()})"  class="delete" data-toggle="modal"><i id="btn_delewater${o.getId()}" class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                    ...
                    <form action ="AddGiaNuocCN" method="post">  
                        ...
                        <div class="modal-body">					
                            <div class="form-group">
                                ...
                                <input name ="luongNuoc" id="tv_luong_nuoc" type="text" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>Đơn giá</label>
                                <input name ="donGia1" id="tv_don_gia" type="number"  class="form-control" required>
                            </div>	
                            <div class="form-group">
                                <label>Năm Áp dụng</label>
                                <input name ="namApdung1" id="tv_nam" type="number" class="form-control" required>
                            </div>	
                        </div>
                        <div class="modal-footer">
                            <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
                            <input type="submit" class="btn btn-success" id="btn_add_nuoc_submit" value="Add">
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="EditGiaNuocCN" method="post">
                        ...
                        <div class="modal-body">
                            <input hidden id="IdEdit" name="IdEdit1"/>
                        ...
                        <div class="modal-footer">
                            ...
                            <input type="submit" class="btn btn-info" id="btn_submit_edit" value="Save">
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="EditGiaNuocDT" method="post">
                        ...
                        <div class="modal-body">
                            <input hidden id="IdEdit" name="IdEdit2"/>
                ...
                <div class="modal-content">
                    <form action="DeleteGiaNuocCN" method="post">
                        ...
                        <div class="modal-footer" style="text-align:center">
                            ...
                            <input type="submit" id="btnXoa"class="btn btn-danger" id="btn_delesub" value="Delete">
                        </div>
                    </form>
                </div>
            </div>
